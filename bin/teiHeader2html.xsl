...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
  ...
  <xsl:param name="docID">MAKS</xsl:param>
  <xsl:param name="author">Darinka Verdonik</xsl:param>
  <xsl:param name="feedbackURL"></xsl:param>
  <xsl:param name="homeURL">http://projekt.slo-na-dlani.si/sl/</xsl:param>
  <xsl:param name="parentWords">http://projekt.slo-na-dlani.si/sl/</xsl:param>
  <xsl:param name="parentURL">http://projekt.slo-na-dlani.si/sl/</xsl:param>
  ...
  <xsl:param name="searchURL">https://www.google.com/search?as_sitesearch=clarin.ijs.si</xsl:param>
